    ...
    <footer className="bg-[#0F172A] text-white/70 border-t border-white/10 mt-20">
      <div className="mx-auto max-w-[1320px] px-6 py-12 grid gap-8 md:grid-cols-3 items-start">
        <div className="flex items-center gap-2">
          <img src={logo} alt="DUD" className="h-10 w-10 object-contain brightness-0 invert" />
          <span className="font-black text-xl text-white tracking-tight">DUD Travel</span>
        </div>
      ...
      <div className="border-t border-white/10 py-5 text-center text-xs">
        © 2026 DUD Travel. All rights reserved.
      </div>
    </footer>
  );
}
